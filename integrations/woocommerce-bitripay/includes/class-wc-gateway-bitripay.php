...
class WC_Gateway_BitriPay extends WC_Payment_Gateway
{
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'api_key'          => array('title' => __('Merchant API key', 'bitripay'), 'type' => 'password', 'description' => __('Create one in the BitriPay merchant dashboard → Payment gateway → API keys (sk_live_… or sk_test_…).', 'bitripay')),
            ...
            'testmode'         => array('title' => __('Test mode', 'bitripay'), 'type' => 'checkbox', 'label' => __('Use a sk_test_ key and show a test badge to customers', 'bitripay'), 'default' => 'no'),
