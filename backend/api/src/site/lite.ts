...
const CSS = `body{font:16px/1.4 system-ui,Arial,sans-serif;margin:0;background:#f6f6fb;color:#161832}main{max-width:480px;margin:0 auto;padding:12px}h1{font-size:20px;margin:8px 0}h2{font-size:17px;margin:14px 0 6px}a{color:#2E2A7B}.card{background:#fff;border:1px solid #dfe3ea;border-radius:8px;padding:12px;margin:10px 0}label{display:block;font-size:14px;margin:8px 0 3px}input,select{width:100%;box-sizing:border-box;padding:9px;font-size:16px;border:1px solid #c8cdd6;border-radius:6px}button{width:100%;padding:11px;font-size:16px;background:#2E2A7B;color:#fff;border:0;border-radius:6px;margin-top:10px}.b{font-weight:700}.m{color:#5b6472;font-size:13px}.err{background:#fde8e8;color:#9b1c1c;padding:8px;border-radius:6px}.ok{background:#e6f7ee;color:#0b6e4f;padding:8px;border-radius:6px}nav a{margin-right:10px;font-size:14px}table{width:100%;border-collapse:collapse;font-size:14px}td{padding:6px 2px;border-bottom:1px solid #eee;vertical-align:top}.r{text-align:right;white-space:nowrap}`;
