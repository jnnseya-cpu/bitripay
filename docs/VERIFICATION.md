...
| Launch languages: Lingala, Kikongo and Tshiluba partial packs that fall back to French, then English | `shared/core/src/locales/{ln,kg,lua}.ts`, `LOCALE_FALLBACKS` in `shared/core/src/locales/index.ts` | `shared/core/src/shared.test.ts` |
