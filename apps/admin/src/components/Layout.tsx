...
const NAV: { section: string; items: { to: string; label: string; ico: string; perm: string }[] }[] = [
  ...
  { section: 'Money', items: [{ to: '/transactions', label: 'All transactions', ico: '📜', perm: 'transactions' }, { to: '/approvals', label: 'Approvals', ico: '✅', perm: 'approvals' }, { to: '/kyc', label: 'KYC verification', ico: '🪪', perm: 'kyc' }, { to: '/p2p', label: 'P2P & disputes', ico: '🤝', perm: 'p2p' }] },
  { section: 'Setup', items: [{ to: '/currencies', label: 'Currencies & rates', ico: '💱', perm: 'settings' }, { to: '/fees', label: 'Fees, limits & referral', ico: '🧮', perm: 'settings' }, { to: '/gateways', label: 'Deposit / payment gateways', ico: '🔌', perm: 'gateways' }, { to: '/mobile-money', label: 'Mobile money operators', ico: '📱', perm: 'gateways' }, { to: '/modules', label: 'Modules & methods', ico: '🧩', perm: 'settings' }, { to: '/catalogs', label: 'Bills, top-up & gift cards', ico: '🧾', perm: 'catalogs' }] },
