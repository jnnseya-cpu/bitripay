...
const NAV: { section: string; items: { to: string; label: string; ico: string; perm: string }[] }[] = [
  ...
  { section: 'Setup', items: [{ to: '/currencies', label: 'Currencies & rates', ico: '💱', perm: 'settings' }, { to: '/fees', label: 'Fees, limits & referral', ico: '🧮', perm: 'settings' }, { to: '/gateways', label: 'Deposit / payment gateways', ico: '🔌', perm: 'gateways' }, { to: '/modules', label: 'Modules & methods', ico: '🧩', perm: 'settings' }, { to: '/catalogs', label: 'Bills, top-up & gift cards', ico: '🧾', perm: 'catalogs' }] },
