...
const NAV: { section: string; items: { to: string; label: string; ico: string; perm: string }[] }[] = [
  ...
  { section: 'Setup', items: [{ to: '/currencies', label: 'Currencies & rates', ico: '💱', perm: 'settings' }, { to: '/fees', label: 'Fees, limits & referral', ico: '🧮', perm: 'settings' }, { to: '/gateways', label: 'Deposit / payment gateways', ico: '🔌', perm: 'gateways' }, { to: '/mobile-money', label: 'Mobile money & evidence', ico: '📱', perm: 'gateways' }, { to: '/channels', label: 'USSD, SMS & Lite', ico: '☎️', perm: 'settings' }, { to: '/controls', label: 'Gateway controls & risk', ico: '🛡️', perm: 'settings' }, { to: '/modules', label: 'Modules & methods', ico: '🧩', perm: 'settings' }, { to: '/catalogs', label: 'Bills, top-up & gift cards', ico: '🧾', perm: 'catalogs' }] },
  { section: 'Website & apps', items: [{ to: '/site', label: 'Web, SEO & app settings', ico: '🌐', perm: 'cms' }, { to: '/seo', label: 'Blog & SEO', ico: '📰', perm: 'cms' }, { to: '/pages', label: 'Pages & links', ico: '📄', perm: 'cms' }, { to: '/languages', label: 'Languages', ico: '🗣️', perm: 'cms' }, { to: '/messaging', label: 'Email, SMS & push', ico: '✉️', perm: 'settings' }] },
  ...
  { section: 'Operations', items: [{ to: '/switch', label: 'National switch & rails', ico: '🔀', perm: 'switch' }, { to: '/finops', label: 'Finance operations', ico: '🧾', perm: 'transactions' }, { to: '/risk', label: 'Risk & compliance', ico: '🛡️', perm: 'compliance' }, { to: '/intelligence', label: 'Intelligence', ico: '🧠', perm: 'agents' }] },
  { section: 'System', items: [{ to: '/agents', label: 'Agents & command centres', ico: '🧭', perm: 'agents' }, { to: '/audit', label: 'Audit logs', ico: '🔍', perm: 'admins' }, { to: '/profile', label: 'My profile & 2FA', ico: '⚙️', perm: '' }] },
];
