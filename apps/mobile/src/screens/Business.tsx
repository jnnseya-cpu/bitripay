...
export function Agent() {
  ...
  return (
    <Screen>
      ...
      <Tabs tabs={[{ id: 'cashin', label: 'Cash-in' }, { id: 'cashout', label: 'Cash-out' }, { id: 'pickup', label: 'Cash pickup' }, { id: 'requests', label: 'Requests' }]} value={tab} onChange={(v) => setTab(v as any)} />
