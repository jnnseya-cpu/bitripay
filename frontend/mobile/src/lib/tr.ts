/**
 * Phrase-level translation for everything the phone app shows: `tr('Add money')` looks the English phrase up in the
...
export function setTrLang(lang: string): void {
  setDisplayLanguage(lang); // country names follow the same language
