      ...
      <div className="grid cols-3">
        ...
        <div className="card" style={{ gridColumn: 'span 2' }}>
          <div className="grid cols-3">
            ...
            <div className="stat">
              <span className="label">Rewards trigger</span>
              <span className="value" style={{ fontSize: '1rem' }}>
                {s?.settings?.trigger === 'first_deposit' ? 'First deposit' : 'Sign-up'}
              </span>
            </div>
          </div>
        ...
        <div className="card">
          ...
          <div className="list">
            {s?.rewards?.map((r: any) => (
              <div key={r.id} className="list-item">
                <div className="flex1">
                  <div className="main-text">Level {r.level} reward</div>
