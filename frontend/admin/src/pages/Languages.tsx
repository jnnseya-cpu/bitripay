  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Enable languages and override any UI string. Apps ship with built-in dictionaries (en, fr, es, pt, ar, sw, hi, bn) and merge your overrides on top."
        actions={<Button onClick={() => setEdit({ code: '', name: '', nativeName: '', rtl: false, enabled: true })}>+ Add language</Button>}
      />
      <div className="grid cols-2">
        <div className="card">
          <Table
            head={['Code', 'Name', 'Native', 'RTL', 'Enabled', '']}
