      ...
      <div className="card">
        {tab === 'trades' && (
          <>
            ...
            <Table
              head={['Reference', 'Buyer', 'Seller', 'Amount', 'Price', 'Method', 'Updated', 'Status', '']}
        ...
        {tab === 'ads' && (
          <Table
            head={['Trader', 'Side', 'Currency', 'Rate', 'Available', 'Status', '']}
        ...
        {sel && (
          <div className="grid cols-2">
            <div>
              ...
              <KV k="Buyer" v={<UserCell user={sel.buyer} />} />
              <KV k="Seller" v={<UserCell user={sel.seller} />} />
              <KV k="Amount" v={money(sel.amount, sel.currency)} />
              <KV k="Price" v={money(sel.priceAmount, sel.priceCurrency)} />
              <KV k="Method" v={sel.paymentMethod} />
